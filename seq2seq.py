...
from amrp import Seq2SeqParser
...
def main():
    ...
    parser.add_argument('--start-eval', type=int, default=35, help='the epoch where start evaluate')
    parser.add_argument('--use-syn', action='store_true', help='whether to use syntax and pos')
    ...
    subparser.add_argument('--encoder', choices=['lstm', 'transformer', 'bart', 'bert'], default='transformer', help='encoder to use')
    ...
    subparser.add_argument('--bert', default='bert-large-uncased', help='which BART model to use')
    ...
    subparser.add_argument('--beam-size', default=5, type=int, help='beam search size')
    subparser.add_argument('--length-penalty', default=1., type=float, help='length penalty for beam search')
    subparser.add_argument('--buckets', default=8, type=int, help='max num of buckets to use')
    subparser.add_argument('--data', default='data/conll14.test', help='path to dataset')
